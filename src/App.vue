  ...
  <div class="flex w-screen h-screen text-gray-700">
    ...
    <div class="flex flex-col flex-grow">
      ...
      <div class="h-16 bg-gray-100 border-t border-gray-300 text-right">
        <button class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded ml-6" @click="saveNote">Save Note</button>
      </div>
    </div>
  </div>
</template>
